...
Since version 3.16.0, ACBR allows loading more localizations from external files (it has to be enabled in the advance preferences).
...
- Français: fr.json (3.16.0-beta1)
- Português (Brasil): pt-Br.json (3.16.0-beta1)
